...
<body>
	<div class="shell">		
		<div id="top-navigation">
			<a title="Log In" href="login.php">Log In</a><a class="cart" title="Shopping Cart" href="#">SHOPPING CART</a><a class="checkout" title="Checkout" href="#">CHECKOUT</a><span>0 items</span><span class="sep">|</span><span>$0,00</span>
		</div>
			...
			<div id="main">
				...
				<div id="sidebar">
					<div class="box">
						...
						<ul>
							<li><a title="Food" href="#">Food</a></li>
							<li><a title="Stationary" href="#">Stationary</a></li>
							<li><a title="Provision" href="#">Provision</a></li>
